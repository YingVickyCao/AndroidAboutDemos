package com.example.hades.androidlibsdemo.qa.only_subscribe_subject_once;
...
import com.example.hades.androidlibsdemo.R;
 ...
 *
 * 业务逻辑：
 * 每次subscribe时，首先检查 If connnect， if yes， subscribe。
 * 每次subscribe时，首先检查 If connnect， if not， 先 connect，然后再subscribe。
 *
 * 模拟:
