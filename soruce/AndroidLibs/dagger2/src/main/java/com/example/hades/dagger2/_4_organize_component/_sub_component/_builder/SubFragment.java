...
public class SubFragment {
    ...
    public void onCreateView() {
        ...
        SubFragmentComponent component = ComponentActivity.getActivity().getActivityComponent().buildSubFragmentComponent()
                .subFragmentModule(new SubFragmentModule()).build();
