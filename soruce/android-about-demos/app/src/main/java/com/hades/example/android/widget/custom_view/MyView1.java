...
//        paint.setColor(Color.RED); //设置画笔颜色
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            paint.setColor(getResources().getColor(R.color.dark_m_0_opacity_80, getContext().getTheme())); //设置画笔颜色
        } else {
            paint.setColor(getResources().getColor(R.color.dark_m_0_opacity_80)); //设置画笔颜色
        }
