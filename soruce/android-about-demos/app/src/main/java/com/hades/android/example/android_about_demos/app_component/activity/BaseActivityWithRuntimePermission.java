...
public class BaseActivityWithRuntimePermission extends Activity {
    ...
    protected void requestPermission(final String... permissions) {
        rxPermissions.request(permissions).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean granted) {
                if (granted) {
                    Toast.makeText(BaseActivityWithRuntimePermission.this, "permission available", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(BaseActivityWithRuntimePermission.this, "permission not granted", Toast.LENGTH_SHORT).show();
                }
            }
