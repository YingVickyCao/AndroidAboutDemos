package com.hades.example.android.android_about_demos.data_storage.db;
...
import com.hades.example.android.android_about_demos.app_component.cp.dict.MyDatabaseHelper;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View source) {
                ...
                // 显示提示信息
                Toast.makeText(TestDBActivity.this, "添加生词成功！", Toast.LENGTH_LONG).show();
            }
        });
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View source) {
                ...
                // 创建一个Intent
                Intent intent = new Intent(TestDBActivity.this, ResultActivity.class);
