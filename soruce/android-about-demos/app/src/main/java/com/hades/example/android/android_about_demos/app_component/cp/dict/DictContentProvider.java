package com.hades.example.android.android_about_demos.app_component.cp.dict;
...
public class DictContentProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        /**
         * insert: uri=content://com.hades.example.android.android_about_demos.app_component.cp.dict.DictContentProvider/words,values=detail=A  detail word=A
        ...
        LogHelper.printThreadInfo(TAG, "insert");
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        LogHelper.printThreadInfo(TAG, "delete");
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        Log.d(TAG, "update: uri=" + uri.toString() + ",where=" + where + ",whereArgs=" + Arrays.toString(whereArgs));
        LogHelper.printThreadInfo(TAG, "update");
    ...
    public Cursor query(Uri uri, String[] projection, String where, String[] whereArgs, String sortOrder) {
        ...
        /**
         * query: uri=content://com.hades.example.android.android_about_demos.app_component.cp.dict.DictContentProvider/words,where=word like ? or detail like ?
         * query,thread =4331,Binder:21984_2
         */
        LogHelper.printThreadInfo(TAG, "query");
