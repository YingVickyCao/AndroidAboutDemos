...
public class BaseActivityWithFragmentWithRuntimePermission extends BaseActivityWithFragment {
    ...
    protected void requestPermission(final String... permissions) {
        rxPermissions.request(permissions).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean granted) {
                if (granted) {
                    Toast.makeText(BaseActivityWithFragmentWithRuntimePermission.this, "permission available", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(BaseActivityWithFragmentWithRuntimePermission.this, "permission not granted", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    protected void askUser2GrantPermissions(final String permissionRationale, final String... permissions) {
        rxPermissions.shouldShowRequestPermissionRationale(this, permissions).subscribe(new Consumer<Boolean>() {
            @Override
