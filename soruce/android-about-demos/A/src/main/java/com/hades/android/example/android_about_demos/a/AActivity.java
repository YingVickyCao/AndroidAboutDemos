...
public class AActivity extends AppCompatActivity {
    ...
    private void jumpB() {
        ComponentName componentName = new ComponentName("com.hades.android.example.android_about_demos.b",
                "com.hades.android.example.android_about_demos.b.BActivity");
    ...
    private void jumpC4ExplicitIntent() {
        ...
        // setComponent
        ComponentName componentName = new ComponentName("com.hades.android.example.android_about_demos.b",
                "com.hades.android.example.android_about_demos.b.CActivity");
//        intent.setComponent(componentName);

        // setClassName
        intent.setClassName("com.hades.android.example.android_about_demos.b",
                "com.hades.android.example.android_about_demos.b.CActivity");
...
//        startActivity(intent);
    ...
    android:exported="true", and no <intent-filter>
     ERROR: android.content.ActivityNotFoundException: No Activity found to handle Intent { act=com.hades.android.example.android_about_demos.b.c cat=[android.intent.category.DEFAULT] (has extras) }
     */
    private void jumpC4ImplicitIntent() {
        Intent intent = new Intent();
        intent.setAction("com.hades.android.example.android_about_demos.b.c");
