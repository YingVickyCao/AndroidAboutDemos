...
public class GestureShow4Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_gesture_4)  ;
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
				// TODO Auto-generated method stub
				GestureRecognize.recognize(GestureShow4Activity.this, myGestureLibrary, gesture) ;
			}
		})  ;
	}
