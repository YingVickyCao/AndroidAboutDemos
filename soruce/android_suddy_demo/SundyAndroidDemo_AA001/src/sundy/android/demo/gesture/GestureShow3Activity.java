...
public class GestureShow3Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_gesture_3)  ;
		...
		gestureView.addOnGesturePerformedListener(new OnGesturePerformedListener() {
			...
			public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
				// TODO Auto-generated method stub
				GestureRecognize.recognize(GestureShow3Activity.this, myGestureLibrary, gesture) ;
			}
		})  ;
	}
